...
public class CreateStudUserRequestDTO
{
    ...
    [StringLength(25,
        ErrorMessage = "Username may be at most 25 characters long.")]
    ...
    [RegularExpression(@"^[^@\s]+@[^@\s]+\.[^@\s]+$",
        ErrorMessage =
            "Email must have a valid domain format (e.g., user@domain.com).")]
    ...
    [RegularExpression(
        ...
        ErrorMessage =
            "Password must contain lowercase, uppercase, a number, and a special character.")]
